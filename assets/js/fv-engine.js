/* Applied Finance Lab: Future Value Studio for Sprint 2B hotfix. */
...
function renderFVStudio() {
  try {
    ...
    if (typeof AFL !== 'undefined') {
      AFL.write({ module1: Math.max(AFL.read().module1, 48), currentSection: 'fv' });
    }
  } catch (error) {
